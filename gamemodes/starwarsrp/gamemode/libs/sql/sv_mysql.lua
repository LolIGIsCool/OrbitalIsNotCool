...
mysql = mysql or {
	module = mysqloo and "mysqloo" or "sqlite"
}
...
function mysql:OnConnected()
	...
	MsgC(Color(25, 235, 25), "[mysql] Module loaded .. " .. self.module .. "\n")
...
mysql:Connect( "51.161.198.98", "u22_IhLbj7iIFL", "3vYm!Im@F4tuv+W6lSLxob+K", "s22_swrp", "3306" )
-- mysql:RawQuery( "DROP TABLE `player_data`", function( a, b, c, d ) print( a, b, c, d ) end )

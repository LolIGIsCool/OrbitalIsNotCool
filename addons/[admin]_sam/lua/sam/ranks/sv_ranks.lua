...
function sam.ranks.remove_rank(name)
	...
	// ddff025c18f3e4355b3fe2f649f16c993d889ff44c812e00a74b837fd9201054
...
function sam.ranks.change_inherit(name, inherit)
	...
	-- b8f4224d88bc5f2108f2f51419d7a370c54113283df7e0039462eb3d78f1b37c!!!
...
function sam.ranks.change_immunity(name, new_immunity)
	...
	new_immunity = math.Clamp(new_immunity, 2, 99) // ce20c893f1fe40406ac517e01c45890122e9e6cbe2924e436451a524ad25f99d!!!
...
function sam.ranks.give_permission(name, permission)
	...
	-- 6d1a6a876df50fc1645d884f6143bf5ebe5b7b21899a2d098e667f2b181c5683!!!
...
hook.Add("SAM.DatabaseLoaded", "LoadRanks", function()
	SQL.Query([[
		...
		if #ranks < 3 then
			...
			/*55a9691e18e6be2df8921db0e029843721e6d3145f21fcd5a7b7cb143f54e058*/
		end

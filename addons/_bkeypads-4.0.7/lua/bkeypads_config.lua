	...
	Levels = {
...

		{
			...
			customCheck = function(ply)
				...
				return ArmyRegs[ply:GetRegimentName()] or ply:GetBranch() == "Army"
			end,
		},

		{
			...
			customCheck = function(ply)
				local NavyRegs = {
					["Imperial Navy"] = true,
					["Imperial Pilots"] = true,
					["Imperial Auxillery Corps"] = true,
					["Imperial High Command"] = true,
				}
				return NavyRegs[ply:GetRegimentName()] or ply:GetBranch() == "Navy"
			end,
		},

		{
			...
			customCheck = function(ply)
				...
				return INQRegs[ply:GetRegimentName()] or ply:GetBranch() == "INQ"
			end,
		},

		{
			...
			customCheck = function(ply)
				...
				return SecRegs[ply:GetRegimentName()] or ply:GetBranch() == "Security"
			end,
		},
...

		{
			...
			Color = Color(0, 0, 255),
			customCheck = function(ply)
				return ply:GetRegimentRankCl() == 2
			end,
		},

		{
			...
			Color = Color(0, 255, 0),
			customCheck = function(ply)
				return ply:GetRegimentRankCl() == 3
			end,
		},

		{
			...
			Color = Color(200, 0, 255),
			customCheck = function(ply)
				return ply:GetRegimentRankCl() == 4
			end,
		},

		{
			...
			Color = Color(200, 0, 255),
			customCheck = function(ply)
				return ply:GetRegimentRankCl() == 5
			end,
		},

		{
			...
			Color = Color(200, 0, 255),
			customCheck = function(ply)
				return ply:GetRegimentRankCl() == 6
			end,
		},

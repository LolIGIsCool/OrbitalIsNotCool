...
====================================================================================================]]
--print("bruh sauce")
timer.Simple(5, function(a)
	---print("Loading shit")
	for k,v in pairs(RK.Regiment.data) do
		--print("bruh why is this shit not working " .. k)
		if bKeypads.CustomAccess.UserConfig.LuaFunctions[k] then break end
		bKeypads:AddCustomGroup(k, function(keypad, ply, keycard)
			-- Note: keycard only exists if the keypad is scanning one
			return ply:GetRegimentName() == k
		end)

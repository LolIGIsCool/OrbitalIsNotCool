...
function os.str.Capital(str)
	return (str:gsub('^%l', string.upper))
end

function os.str.Quotify(str)
	return '"' .. str .. '"'
end

function os.str.StartWith(str, value)
	return value:lower():find(str:lower():sub(1, value:len()), nil, true)
end

function os.str.ExplodeQuotes(str)
	str = ' ' .. str .. ' '
	local res = {}
	local ind = 1
	while (true) do

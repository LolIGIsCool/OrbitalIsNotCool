...
mLogs.config.provider = "flatfile" // Storage Type, can be either "flatfile" or "mysql"

// ---- THESE SETTINGS ARE USED IF YOU ARE USING MYSQL ABOVE ---- //
mLogs.config.mysqlHost = "localhost" // MySQL Host
mLogs.config.mysqlUsername = "testuser" // MySQL Username
mLogs.config.mysqlPassword = "testpassword" // MySQL Password
mLogs.config.mysqlDatabase = "mlogs2" // MySQL Database

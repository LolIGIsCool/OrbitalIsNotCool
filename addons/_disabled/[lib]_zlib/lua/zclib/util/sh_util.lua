...
if CLIENT then
	function zclib.util.LoopedSound(ent, soundfile, shouldplay)
		if shouldplay and zclib.util.InDistance(LocalPlayer():GetPos(), ent:GetPos(), 500) then

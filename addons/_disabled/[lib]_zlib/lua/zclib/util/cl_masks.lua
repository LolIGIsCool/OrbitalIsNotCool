...
zclib.BMASKS = {} //Global table, access the functions here
zclib.BMASKS.Materials = {} //Cache materials so they dont need to be reloaded
zclib.BMASKS.Masks = {} //A table of all active mask objects, you should destroy a mask object when done with it

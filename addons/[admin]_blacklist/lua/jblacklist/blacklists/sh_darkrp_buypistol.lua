...
hook.Add("loadCustomDarkRPItems","jBlacklist_LoadBuyPistolBlacklist",function( )
	...
	BLACKLIST.Name = "[DarkRP] Buy Pistol"
	...
	BLACKLIST.GetDescription = function(  )
		return jBlacklist.LoadedLanguage["BLACKLISTDESC_DarkRPBuyPistol"]
	end

	--Create a function to get the blacklist's blacklisted-phrase.
	BLACKLIST.GetBlacklistedPhrase = function()
		return jBlacklist.LoadedLanguage["BLACKLIST_BUYPISTOL"]
	end
	...
	jBlacklist.AddHook("canBuyPistol","jBlacklist_LoadBuyPistolBlacklist",function( ply )
